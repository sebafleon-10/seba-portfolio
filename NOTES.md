...
Last updated: September 18, 2026 (Experience color marks, plate removed, clearZones list)
...
- A gravity anchor with no opaque surface (the Experience mark) must also publish a clear zone, or the network collects on top of it
